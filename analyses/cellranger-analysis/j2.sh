...
for config_dir in ./results/02_cellranger_count/${cellranger_parameters}/multi_config_*; do
    # Extract the value of "something" (the part after multi_config_)
    library_name=$(basename "$config_dir" | sed 's/^multi_config_//')
