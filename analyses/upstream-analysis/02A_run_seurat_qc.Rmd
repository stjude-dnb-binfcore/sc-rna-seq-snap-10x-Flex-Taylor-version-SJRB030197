...
cat("Beginning to process sample:", sample, "\n")

if (use_SoupX_filtering == "YES"){
  print_message <- "we will use SoupX corrected matrix"
  
   sample_SoupX_input_dir <- file.path(SoupX_results_dir, sample) 
   ...
   # we will update the name of the assay in the `04_run_filter_object.Rmd`
    ...
    counts_mat <- load_sample_counts_matrix(path = sample_input_dir, sample_name = sample)
  
    # Create seurat object using gene expression data
    seurat_obj <- create_seurat_obj(counts_matrix = counts_mat[["Gene Expression"]], assay = "RNA")
...
sample_metadata <- rbind(project_metadata[sample, ], project_metadata[sample, ][rep(1, length(seurat_obj$nCount_RNA)-1), ])
...
cat("Number of cells before filter for", sample, ":", "\n")
...
cat("Generating QC plots for RAW data for sample", sample, "\n")
fname <- paste0(samples_plots_dir, "/", sample, "_", "01", "_before_filter_vln_plot.png")
...
Generate_QC_Plots_1(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "02", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)

Generate_QC_Plots_2(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "03", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)

Generate_QC_Plots_3(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "04", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)

Generate_QC_Plots_4(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "05", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)

Generate_QC_Plots_5(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "06", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)

Generate_QC_Plots_6(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "07", Analysis_Name = sample, 
                    File_Name = "QC_Raw_Data", palette = gradient_palette_df)
```
...
cat("Number of cells after filtering for sample", sample, ":", "\n")
...
cat("Number of cells express a specific gene for sample", sample, "\n")
...
fname <- paste0(samples_plots_dir, "/", sample, "_", "08", "_cells_num_per_gene.png")
print(fname)
set.seed(1234) # Set seed
...
cat("Number of expressed genes in the library for sample", sample, "\n")
...
fname <- paste0(samples_plots_dir, "/", sample, "_", "09", "_genes_num_library.png")
print(fname)
set.seed(1234) # Set seed
...
cat("Generating QC plots for FILTERED data for sample", sample, "\n")
fname <- paste0(samples_plots_dir, "/", sample, "_", "10", "_after_filter_vln_plot.png")
print(fname)
...
Generate_QC_Plots_1(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "11", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)

Generate_QC_Plots_2(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "12", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)

Generate_QC_Plots_3(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "13", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)

Generate_QC_Plots_4(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "14", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)

Generate_QC_Plots_5(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "15", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)

Generate_QC_Plots_6(Seurat_obj = seurat_obj, Project_Path = seurat_qc_plots_dir, Figure_Total = "16", Analysis_Name = sample, 
                    File_Name = "QC_Filtered_Data", palette = gradient_palette_df)
```
...
if (cells_so_after_filter_num >= 500) {
  ...
  cat("Create and process seurat for sample", sample, "\n")
  ...
  cat("Save Seurat object for sample", sample, "\n")
